...
const technologies = [
  { name: 'React', icon: 'https://cdn.simpleicons.org/react/61DAFB', category: 'UI Library', desc: 'Component-based UIs' },
  { name: 'Next.js', icon: 'https://cdn.simpleicons.org/nextdotjs/ffffff', category: 'Framework', desc: 'Full-stack React apps' },
  { name: 'TypeScript', icon: 'https://cdn.simpleicons.org/typescript/3178C6', category: 'Language', desc: 'Type-safe JavaScript' },
  { name: 'Tailwind', icon: 'https://cdn.simpleicons.org/tailwindcss/06B6D4', category: 'Styling', desc: 'Utility-first CSS' },
  { name: 'Node.js', icon: 'https://cdn.simpleicons.org/nodedotjs/339933', category: 'Backend', desc: 'Server-side runtime' },
  { name: 'React Query', icon: 'https://cdn.simpleicons.org/reactquery/FF4154', category: 'Data Fetching', desc: 'Async state management' },
  { name: 'Docker', icon: 'https://cdn.simpleicons.org/docker/2496ED', category: 'DevOps', desc: 'Container deployment' },
  { name: 'PostgreSQL', icon: 'https://cdn.simpleicons.org/postgresql/4169E1', category: 'Database', desc: 'Relational data storage' },
];
...
const TechCircle = forwardRef<
  HTMLDivElement,
  { className?: string; icon: string; name: string }
>(({ className, icon, name }, ref) => (
  ...
  >
    <img src={icon} alt={name} className="w-full h-full object-contain" referrerPolicy="no-referrer" />
  </div>
));
            ...
            <div className="relative flex w-full max-w-160 items-center justify-between px-6 py-10">
              ...
              <div className="flex flex-col gap-7">
                {technologies.slice(4, 8).map((tech, i) => (
                  <TechCircle key={tech.name} ref={techRefs[i + 4]} icon={tech.icon} name={tech.name} />
                ))}
              </div>
            </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p
                      ...
                      style={{ color: 'rgba(255,255,255,0.82)', fontFamily: 'monospace', letterSpacing: '0.02em' }}
                    >
                      {tech.name}
                    </p>
                    <p
