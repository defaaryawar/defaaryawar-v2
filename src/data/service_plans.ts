  ...
  "travel-tour": [
    {
      ...
      color: "#ffffff",
      features: [
        { name: "Catalog", value: "Up to 15 Packages", inc: true },
        { name: "Booking System", value: "via WhatsApp", inc: true },
        { name: "Design Mockup", value: "1x Preview Halaman", inc: true },
        { name: "Responsive Design", value: "Mobile Friendly", inc: true },
        { name: "Domain .com", value: "Gratis Setahun", inc: true },
        { name: "Hosting", value: "Fast & Secure", inc: true },
        { name: "SEO Optimization", value: "Basic Setup", inc: true },
        { name: "Trust Indicator", value: "Aman & Terpercaya", inc: true },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "CMS Dashboard", value: "Kelola Paket Sendiri", inc: true },
        { name: "Booking System", value: "Direct Web Booking", inc: true },
        { name: "Design Mockup", value: "2x Preview Halaman", inc: true },
        { name: "Social Media", value: "IG/FB/TikTok Integration", inc: true },
        { name: "Responsive Design", value: "Mobile Friendly", inc: true },
        { name: "Domain .com / .id", value: "Gratis Setahun", inc: true },
        { name: "Hosting", value: "High Performance", inc: true },
        { name: "SEO Optimization", value: "Advanced Setup", inc: true },
        { name: "Trust Indicator", value: "Aman & Terpercaya", inc: true },
    ...
    },
    {
      ...
      features: [
        { name: "Catalog", value: "Unlimited Packages", inc: true },
        { name: "CMS Dashboard", value: "Advanced + Analytics", inc: true },
        { name: "Booking System", value: "Auto Confirmation", inc: true },
        { name: "Payment Gateway", value: "VA, CC, QRIS Ready", inc: true },
        { name: "Design Mockup", value: "Full Prototype Preview", inc: true },
        { name: "Social Media", value: "Advanced Integration & Pixel", inc: true },
        { name: "SEO Optimization", value: "Premium Setup", inc: true },
        { name: "Domain", value: "Bebas Pilih Ekstensi", inc: true },
        { name: "Hosting", value: "Dedicated Performance", inc: true },
        { name: "Responsive Design", value: "Mobile Friendly", inc: true },
        { name: "Trust & Security", value: "Aman, Terpercaya & SSL", inc: true },
        { name: "Revisions", value: "Unlimited", inc: true },
